...
<body>
  <div class="container-scroller">
    ...
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        <a class="navbar-brand brand-logo" href="/fraa">
          <h2 class="text-info">S U F R A</h2>
        </a>
        <a class="navbar-brand brand-logo-mini" href="/fraa">
          <h1 class="text-info">S</h1>
        </a>
      </div>
      <div class="navbar-menu-wrapper d-flex align-items-stretch">
        ...
        <ul class="navbar-nav navbar-nav-right">
          <div class="nav-profile-text">
            <p class="mb-1 text-info"><strong>Admin</strong> </p>
          </div>
              ...
              <div class="dropdown-menu dropdown-menu-end navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="assets2/images/faces/face4.jpg" alt="image" class="profile-pic">
                  </div>
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="assets2/images/faces/face2.jpg" alt="image" class="profile-pic">
                  </div>
                  <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="assets2/images/faces/face3.jpg" alt="image" class="profile-pic">
                  </div>
                  <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
          ...
          <!-- <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                <div class="nav-profile-image">
                  <img src="assets2/images/faces/face1.jpg" alt="profile" />
                  <span class="login-status online"></span>
                  change to offline or busy as needed
                </div>
                <div class="nav-profile-text d-flex flex-column">
                  <span class="font-weight-bold mb-2">David rey. H</span>
      ...
      <div class="main-panel">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex mt-5 align-items-top">
                      <img src="assets2/images/faces/face3.jpg" class="img-sm rounded-circle me-3" alt="image">
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">© Copyright <strong>S U F R A</strong>. All rights reserved.</span>
  ...
  <script src="assets2/js/jquery.cookie.js"></script>
  <!-- endinject -->
